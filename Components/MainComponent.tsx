...
function MainComponent() {
  ...
  return (
    <div>
      ...
      <div className = 'coinbase-footer-wrapper mt-16 p-16 bg-black flex'>
        <div className = 'coinbase-description-container'>
          <div className = 'coinbase-footer-img'>
            <img src= {coinbasef} />
          </div>
            <div className = 'coinbase-desscription-header flex mt-6 mb-6'>
              <a className = 'text-slate-300 text-justify'> Fusce ut elit aliquet, fermentum leo vel, tempus nunc. Fusce eu rhoncus augue. Fusce vel metus pharetra, fermentum</a>
            </div>
