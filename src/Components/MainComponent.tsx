...
function MainComponent() {
  return (
    <div>
      ...
      <div className = 'blog-crypto-wrapper'>
        <div className = 'blog-crypto-container'>
           <div className = 'blog-crypto-text'>
              <h1 className = 'text-2xl pb-2 font-semibold pt-4'>Our blog</h1>
              <a>Get to know the latest stuff via our blog post.</a>
           </div>
           <div className = 'blog-crypto-cards flex'>
              ...
              <div className = 'blog-card-business'>
                 
              </div>
              <div className = 'blog-card-life'>
